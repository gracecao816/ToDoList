...
import static gracecao.simpletodo.MainActivity.ITEM_POSITION;
import static gracecao.simpletodo.MainActivity.ITEM_TEXT;
...
public class EditItemActivity extends AppCompatActivity {
    ...
    public void onSaveItem(View v) {
        ...
        //closes the edit activity, passes intent back to main
        finish();
    }
